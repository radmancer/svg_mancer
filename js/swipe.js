...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    function stackedCards() {
        ...
        function redirectToProfile(queryString){
            window.location = "profile.html" + queryString;
        }

        function changeQueryString(currentCardNumber) {
            var queryString = document.getElementById("cardInput" + currentCardNumber).value;
            redirectToProfile(queryString);
        }
        ...
        //This retrieves the last known card that the user was looking at.
        //It isn't known whether we can just jump to a specific card on the stack.
